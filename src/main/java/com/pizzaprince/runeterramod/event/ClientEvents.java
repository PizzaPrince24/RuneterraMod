...
import com.pizzaprince.runeterramod.entity.client.custom.*;
...
import com.pizzaprince.runeterramod.entity.client.projectile.CasterMinionProjectileRenderer;
...
public class ClientEvents {
	...
	public static class ClientModEvents {
		...
		public static void onClientSetup(FMLClientSetupEvent event) {
			...
			EntityRenderers.register(ModEntityTypes.SUN_DISK.get(), SunDiskRenderer::new);
			EntityRenderers.register(ModEntityTypes.BLUE_CASTER_MINION.get(), BlueCasterMinionRenderer::new);
			EntityRenderers.register(ModEntityTypes.BLUE_MELEE_MINION.get(), BlueMeleeMinionRenderer::new);
			EntityRenderers.register(ModEntityTypes.BLUE_CANNON_MINION.get(), BlueCanonMinionRenderer::new);
			EntityRenderers.register(ModEntityTypes.BLUE_SUPER_MINION.get(), BlueSuperMinionRenderer::new);
		...
		public static void onClientSetup(EntityRenderersEvent.RegisterRenderers event) {
			...
			event.registerEntityRenderer(ModEntityTypes.CASTER_MINION_PROJECTILE.get(), CasterMinionProjectileRenderer::new);
		}
